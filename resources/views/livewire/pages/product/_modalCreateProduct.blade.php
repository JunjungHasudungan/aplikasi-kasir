<div>
    <div class="fixed z-10 inset-0 overflow-y-auto ease-out duration-400">
        ...
        <div class="absolute inset-0 bg-gray-500 opacity-75"></div>
          ...
          <div class="inline-block align-bottom  dark:bg-gray-700 bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
